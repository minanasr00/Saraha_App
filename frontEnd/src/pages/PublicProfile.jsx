          ...
          <div className="px-6 pb-8 text-center">
            ...
            <div className="mt-6 text-center">
              <p className="text-white/80 text-lg mb-4">
                Create your account now and start receiving your messages
              </p>
              <button
                onClick={() => navigate('/signup')}
                className="w-full bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white py-4 px-6 rounded-2xl transition-all shadow-xl font-semibold text-lg flex items-center justify-center transform hover:scale-105"
              >
                <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
